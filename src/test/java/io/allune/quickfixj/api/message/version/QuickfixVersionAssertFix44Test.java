 ...
 */
public class QuickfixVersionAssertFix44Test {

	@Test
	public void shouldAssertIsVersionFix44() throws InvalidMessage {
		Message message = new Message("8=FIX.4.4\u00019=61\u000135=A\u000134=1\u000149=BANZAI\u000152=20200408-06:49:07\u000156=EXEC\u000198=0\u0001108=30\u000110=019\u0001");
		assertThat(message).hasVersion().fix44();
	}

	@Test
	public void shouldFailToAssertIsVersionFix44GivenMessageWithVersionFix40() throws InvalidMessage {
		try {
