 ...
 */
public class QuickfixVersionAssertFixt11Test {

	@Test
	public void shouldAssertIsVersionFixt11() throws InvalidMessage {
		Message message = new Message("8=FIXT.1.1\u00019=61\u000135=A\u000134=1\u000149=BANZAI\u000152=20200408-06:49:07\u000156=EXEC\u000198=0\u0001108=30\u000110=97\u0001");
		assertThat(message).hasVersion().fixt11();
	}

	@Test
	public void shouldFailToAssertIsVersionFixt11GivenMessageWithVersionFix40() throws InvalidMessage {
		try {
