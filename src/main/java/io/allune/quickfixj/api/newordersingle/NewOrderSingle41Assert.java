 ...
 */
public class NewOrderSingle41Assert extends AbstractNewOrderSingle<NewOrderSingle41Assert, NewOrderSingle> {

	public NewOrderSingle41Assert(NewOrderSingle actual) {
